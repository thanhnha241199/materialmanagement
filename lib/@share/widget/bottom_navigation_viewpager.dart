...
class _BottomNavigationViewPagerState extends State<BottomNavigationViewPager> {
  ...
  Widget itemBottomBar(int index, Function(int)? action) => ClipRRect(
        ...
        child: BottomNavigationBar(
          ...
          items: [
            _itemBottomNavigation(icon: AppImages.icHome, label: 'Trang chủ'),
            _itemBottomNavigation(icon: AppImages.icDiscovery, label: ''),
            _itemBottomNavigation(icon: AppImages.icBuy, label: ''),
            _itemBottomNavigation(icon: AppImages.icCategory, label: ''),
            _itemBottomNavigation(icon: AppImages.icNotification, label: ''),
          ],
        ),
      );
